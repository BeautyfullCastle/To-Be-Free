...
namespace ToBeFree
{
	public enum eEventAction
	{
		...
		CAMP_SPECIAL = 0x100000, REST_SPECIAL = 0x200000, HIDE_SPECIAL = 0x400000,
		QUEST = 0x800000,
		INVESTIGATION_BROKER_SPECIAL = 0x1000000, INVESTIGATION_POLICE_SPECIAL = 0x2000000, INVESTIGATION_CITY_SPECIAL = 0x4000000,
		QUEST_BROKERINFO = 0x8000000,
		ABILITY = 0x10000000
	}
